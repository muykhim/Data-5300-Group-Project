...
ggplot(ua_weather, aes(x = month.x, y = dep_delay)) +
  geom_boxplot() +
  labs(title = "Departure Delays by Month", x = "Month", y = "Delay (minutes)")
...
ggplot(by_origin_monthly, aes(x = month, y = dep_delay)) +
  geom_boxplot() +
  labs(title = "Departure Delays by Month", x = "Month", y = "Delay (minutes)")
